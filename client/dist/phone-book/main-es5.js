...
var AddressBookComponent = /** @class */ (function () {
    function AddressBookComponent(phoneBookService, messageService) {
    ...
    AddressBookComponent.prototype.onRegister = function () {
        var _this = this;
        if (this.userRegister && Object.values(this.userRegister) && !Object.values(this.userRegister).every(function (val) { return val === null; })) {
            var requestPayload = Object.assign({}, this.userRegister);
            requestPayload.gender = "";
            requestPayload.profilePic = "";
            requestPayload.techStack = requestPayload.techStack.split(',');
            console.log('requestPayload', requestPayload);
            this.phoneBookService.registerUser(this.userRegister).subscribe(function (res) {
                console.log(res);
                _this.onClear();
                _this.addSingle();
                setTimeout(function () {
    ...
    AddressBookComponent.prototype.addSingle = function () {
        this.messageService.add({ severity: 'success', summary: 'Service Message', detail: 'Via MessageService' });
    };
    AddressBookComponent.prototype.clear = function () {
        this.messageService.clear();
    };
    AddressBookComponent.prototype.resetUserForm = function (form) {
        form.resetForm();
    };
    AddressBookComponent.prototype.onClear = function () {
        for (var key in this.userRegister) {
...
var routes = [
    ...
    {
        path: 'search',
        loadChildren: function () { return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ../library/phone-book/phone-book.module */ "./src/library/phone-book/phone-book.module.ts")).then(function (m) { return m.PhoneBookModule; }); }
    },
    {
        path: 'register',
...
var PhoneBookDetailComponent = /** @class */ (function () {
    function PhoneBookDetailComponent(activateRoute, phoneBookService, location) {
        this.activateRoute = activateRoute;
        this.phoneBookService = phoneBookService;
        this.location = location;
    }
    PhoneBookDetailComponent.prototype.ngOnInit = function () {
        this.getSelectedUser();
    };
    /**
     * Method to get the user details based on the ID.
     */
    PhoneBookDetailComponent.prototype.getSelectedUser = function () {
        var _this = this;
        this.activateRoute.paramMap.subscribe(function (res) {
            var userName = res.get('ID');
            _this.getUserDetail(userName);
        }, function (err) { return console.log(err); });
    };
    /**
     ...
     */
    PhoneBookDetailComponent.prototype.getUserDetail = function (user) {
        var _this = this;
        this.subscription = this.phoneBookService.getUserData(user).subscribe(function (res) {
            var response = res.response[0];
            response.techStack = typeof response.techStack !== 'string' ? JSON.parse(response.techStack) : response.techStack.split(',');
            _this.selectedUserData = Object.assign({}, response);
            console.log(_this.selectedUserData);
        });
    };
    PhoneBookDetailComponent.prototype.ngOnDestroy = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    PhoneBookDetailComponent.ctorParameters = function () { return [
    ...
    return PhoneBookDetailComponent;
}());
...
var PhoneBookListComponent = /** @class */ (function () {
    function PhoneBookListComponent(interactionService, router, route) {
    ...
    PhoneBookListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subscription = this.interactionService.getRelayedMessage$.subscribe(function (res) {
            _this.userDataList = res;
        });
     ...
     */
    PhoneBookListComponent.prototype.onViewDetails = function (selectedUser) {
        this.retainedDataList = this.userDataList;
        this.router.navigate(['/userdetail', { ID: selectedUser }], { relativeTo: this.route });
    };
    PhoneBookListComponent.prototype.ngOnDestroy = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    PhoneBookListComponent.ctorParameters = function () { return [
...
var SearchPhoneBookComponent = /** @class */ (function () {
    function SearchPhoneBookComponent(phoneBookService, interactionService) {
        this.phoneBookService = phoneBookService;
        this.interactionService = interactionService;
        this.userQuery = new _models_user_query__WEBPACK_IMPORTED_MODULE_2__["UserQuery"]();
    }
    SearchPhoneBookComponent.prototype.ngOnInit = function () {
        this.onSubmit();
    };
    /**
     * Method to fetch the user data
     */
    SearchPhoneBookComponent.prototype.onSubmit = function () {
        var _this = this;
        this.subscription = this.phoneBookService.getUserData(this.userQuery.id, this.userQuery.firstName, this.userQuery.lastName, this.userQuery.email)
            ...
            if (res.response && res.response.length > 0) {
                _this.dataList = res.response;
                _this.sendDataList(_this.dataList);
            }
        }, function (err) { return console.log(err); });
    };
    /**
   ...
   */
    SearchPhoneBookComponent.prototype.onClear = function () {
        var _this = this;
        this.subscription = this.phoneBookService.getUserData()
            .subscribe(function (res) {
            if (res.response && res.response.length > 0) {
                _this.userQuery.id = "";
                _this.userQuery.firstName = "";
                _this.userQuery.lastName = "";
                _this.userQuery.email = "";
                _this.dataList = res.response;
                _this.sendDataList(_this.dataList);
            }
        }, function (err) { return console.log(err); });
     ...
     */
    SearchPhoneBookComponent.prototype.sendDataList = function (userData) {
        this.interactionService.sendDataAccross(userData);
    };
    SearchPhoneBookComponent.prototype.ngOnDestroy = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
    };
    SearchPhoneBookComponent.ctorParameters = function () { return [
        { type: _services_phone_book_service_service__WEBPACK_IMPORTED_MODULE_3__["PhoneBookService"] },
    ...
    return SearchPhoneBookComponent;
}());
...
var ViewPhoneBookComponent = /** @class */ (function () {
    function ViewPhoneBookComponent() {
    }
    ViewPhoneBookComponent.prototype.ngOnInit = function () {
    };
...
var ValidatorDirective = /** @class */ (function () {
    function ValidatorDirective() {
    }
    ValidatorDirective_1 = ValidatorDirective;
    /**
     * Validator function to validate the email input field.
     * @param control Abstract Control of the form
     */
    ValidatorDirective.prototype.validate = function (control) {
...
var UserRegisterResponse = /** @class */ (function () {
...
var InteractionService = /** @class */ (function () {
     ...
     */
    InteractionService.prototype.sendDataAccross = function (data) {
...
var PhoneBookService = /** @class */ (function () {
     ...
     */
    PhoneBookService.prototype.getUserData = function (ID, firstName, lastName, email) {
        var url = 'http://localhost:4500/resource';
   ...
   */
    PhoneBookService.prototype.registerUser = function (userRegister) {
        var url = 'http://localhost:4500/resource';
    ...
    PhoneBookService.prototype.errorHandler = function (error) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(error);
    };
    PhoneBookService.ctorParameters = function () { return [
